-- =====================================================================
--  PHYSICS NATIONAL CERTIFICATE — MEGA-PLATFORMA
--  Optimallashgan InnoDB sxemasi (utf8mb4 / High-Load READY)
--  Replikatsiya, partitioning va index strategiyalari hisobga olingan
-- =====================================================================
...
DROP DATABASE IF EXISTS `physics_cert`;
CREATE DATABASE `physics_cert`
